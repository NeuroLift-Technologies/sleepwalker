# AGENTS.md — NeuroLift Technologies sleepwalker Repository Agent Gateway

> **Internal use only.** This is the repository-specific governance gateway for coding agents operating in this repository. This copy is scoped to NeuroLift-Technologies/sleepwalker, with project-specific operational context kept in this repository.
...
> **Repo-local note:** Governance docs in this repository are the working copy for NeuroLift-Technologies/sleepwalker. Keep references local unless Joshua explicitly asks for an upstream sync.
...
- Repo-local governance context: [NeuroLift-Technologies/sleepwalker](https://github.com/NeuroLift-Technologies/sleepwalker)
